...
const STEPS = [
  ...
  { t: 'Σε συνδέουμε με θεραπευτή', d: 'Ο αλγόριθμος αντιστοίχισης σου αναθέτει τον καταλληλότερο αδειούχο θεραπευτή — συνήθως μέσα σε 24 ώρες — και σου εξηγεί γιατί.' },
